...
UPGRADE_COSTS = {'common': 20, 'uncommon': 40, 'rare': 80, 'epic': 160, 'legendary': ''}
...
class GLOBAL:
    def __init__(self) -> None:
        ...
        self.AUTH = identity.web.Auth(session=session, authority=self.APP.config.get("AUTHORITY"), client_id=self.APP.config["CLIENT_ID"], client_credential=self.APP.config["CLIENT_SECRET"],)
